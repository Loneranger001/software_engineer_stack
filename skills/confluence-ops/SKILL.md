...
metadata:
  version: "0.2.4"
  supported_languages: "python, markdown, html"
  supported_frameworks: "github-copilot-skills, confluence-cloud-rest-api"
  supported_operating_systems: "macos, linux, windows"
  categories: "documentation, tooling"
  tags: "confluence, wiki, atlassian, documentation, pages, spaces, cql-search"
  input_format: "Page IDs, URLs, CQL queries, HTML/markdown content for page operations"
  output_format: "Markdown-converted page content, Confluence page create/update confirmations"
---
