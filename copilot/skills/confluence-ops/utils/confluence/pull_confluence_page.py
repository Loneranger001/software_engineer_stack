...
EXAMPLES:
    ...
    python3 pull_confluence_page.py "https://your-org.atlassian.net/wiki/spaces/SPACE/pages/123456789/Some+Page"
    python3 pull_confluence_page.py "https://your-org.atlassian.net/wiki/x/EodugAE"
...
# Atlassian site comes from the environment — see write.py resolve_base_url().
CONFLUENCE_URL = (os.environ.get("CONFLUENCE_URL", "").rstrip("/")
                 or (os.environ.get("JIRA_URL", "").rstrip("/") + "/wiki"
                     if os.environ.get("JIRA_URL") else ""))
...
**Source**: [Confluence Page]({CONFLUENCE_URL}/pages/viewpage.action?pageId={page_id})
**Version**: {version}
