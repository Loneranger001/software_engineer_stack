...
same instructions: explicitly as prompt files in Copilot Chat (`/change-request`, `/confluence-ops`, `/deliver`, `/document`, `/estate-profile`, `/grill`, `/impl-plan`, `/implement`, `/intake`, `/jira-ops`, `/meeting-minutes`, `/repo-profile`, `/research`, `/retro`, `/tech-design`, `/understand`, `/verify-code`) and as
