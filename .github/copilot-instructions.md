...
agent load automatically when a request matches a stage's description. Tool skills (`/confluence-ops`, `/jira-ops`) wrap external systems and are called by the stages rather than run as stages themselves — no workspace, no gate.
