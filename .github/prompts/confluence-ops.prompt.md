...
> Arguments: `<operation> [page-id|url|CQL]`
...
python3 ./skills/confluence-ops/utils/confluence/pull_confluence_page.py 5575940659

# Pull page by URL
python3 ./skills/confluence-ops/utils/confluence/pull_confluence_page.py "https://your-org.atlassian.net/wiki/spaces/SPACE/pages/123456789/Some+Page"

# Pull page by short URL
python3 ./skills/confluence-ops/utils/confluence/pull_confluence_page.py "https://your-org.atlassian.net/wiki/x/EodugAE"

# Save to file
python3 ./skills/confluence-ops/utils/confluence/pull_confluence_page.py 5575940659 docs/pulled/my-page.md
```
...
# ─── Create page ───────────────────────────────────────────
# Inline HTML body
python3 ./skills/confluence-ops/utils/confluence/write.py create --space SPACE --title "My Page" --body "<h1>Hello</h1>"

# Body from HTML file (preferred for large content)
python3 ./skills/confluence-ops/utils/confluence/write.py create --space SPACE --title "My Page" --body-file body.html

# With parent page
python3 ./skills/confluence-ops/utils/confluence/write.py create --space SPACE --title "Child Page" --body-file body.html --parent 5575940659

# Personal space (replace with your own space key)
python3 ./skills/confluence-ops/utils/confluence/write.py create --space "~YOUR_ACCOUNT_ID" --title "My Draft" --body-file body.html

# ─── Update page ───────────────────────────────────────────
# Update body only (keeps current title, auto-increments version)
python3 ./skills/confluence-ops/utils/confluence/write.py update 5575940659 --body-file updated_body.html

# Update title and body
python3 ./skills/confluence-ops/utils/confluence/write.py update 5575940659 --title "New Title" --body-file body.html
...
python3 ./skills/confluence-ops/utils/confluence/write.py move PAGE_ID --space "~YOUR_ACCOUNT_ID" --yes

# Into a space under a specific parent
python3 ./skills/confluence-ops/utils/confluence/write.py move 6105498164 --space SPACE --parent 5575940659 --yes

# ─── Search pages ──────────────────────────────────────────
python3 ./skills/confluence-ops/utils/confluence/write.py search "type=page AND space=SPACE AND title~'Design'"
python3 ./skills/confluence-ops/utils/confluence/write.py search "type=page AND label='sdp-platform'" --limit 50
```
...
```python
import sys
sys.path.insert(0, "./skills/confluence-ops/utils/confluence")
...
```bash
python3 ./skills/confluence-ops/utils/confluence/write.py notifications                  # Last 24 hours
python3 ./skills/confluence-ops/utils/confluence/write.py notifications --days 7         # Last week
python3 ./skills/confluence-ops/utils/confluence/write.py notifications --spaces SPACE   # Specific space only
python3 ./skills/confluence-ops/utils/confluence/write.py notifications --days 3 --spaces SPACE1,SPACE2  # Custom
```
