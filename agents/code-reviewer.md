...
4. **Conventions**: against the `.conventions.md` of the repo the reviewed
   file belongs to (repo roots are recorded in the task's STATUS.md; in a
   multi-repo change each repo is judged by its own rules) first,
